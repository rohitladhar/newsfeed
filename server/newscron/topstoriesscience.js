...
exports.topstoriesscience = async() =>{
    try {
        const url = "https://api.nytimes.com/svc/topstories/v2/science.json?api-key=76VzJwHRIXvSoSJHFDFR4kXrQLc7BCtuRAuBsJ";
        fetch(url)
...
//const topStories = async(res,data)=>{
    ...
    return "CRON WORKED TOP STORIES SCIENCE";
